...
public class DialogueButtonEffect2 : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    [Header("Components")]
    ...
    public float hoverMoveDistance = 60f;
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        // 위로 살짝 올라감
        rectTransform.DOAnchorPosX(originalPos.x - hoverMoveDistance, 0.2f);
    }
    ...
    public void OnPointerExit(PointerEventData eventData)
    {
        ...
        // 원래 위치로 복귀
        rectTransform.DOAnchorPosX(originalPos.x, 0.2f);
    }
